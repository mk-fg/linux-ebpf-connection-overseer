...
- Unprivileged system-daemon python script that uses eBPF map file descriptors
  to monitor for network-related info and export it to some fifo socket as json lines.

- User session tool to read that json data and visualize in some useful way.
